...
class ComplexityTag(BaseModel):
    ...
    issue_price : Required[str] = Field(description="the Issue price or Nominal Amount (NA)")
    floor_amount: Required[str] = Field(description="The guaranteed level, Protection, Floor level, Floor Amount")
    protection: Required[str] = Field(description="The percentage of protection")
    barrier_level: Required[str] = Field(description="the Barrier Level")
    strike_level: Required[str] = Field(description="the Strike Level")
    ...
    maximum_payment: Required[str] = Field(description = "Maximum Amount paid at the Redemtpion date")
    underlying_bloomberg: Required[str] = Field(description = "Product's underlying, give me the Bloomberg Codes")
    underlying_isin: Required[str] = Field(description = "Product's underlying, give me the ISIN")
    issue_date: Required[str] = Field(description = "Certificate's issue date")
    final_payment_date: Required[str] = Field(description = "Final Payment date, also described by Maturity date")
